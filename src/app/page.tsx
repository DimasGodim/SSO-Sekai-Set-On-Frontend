      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-6xl sm:text-8xl lg:text-9xl font-bold text-glow-blue katakana-overlay">
              世界
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-neon-blue text-neon-blue hover:bg-neon-blue/10 transition-all duration-300 text-lg px-8 py-3"
            >
              <Link href="/docs">
                View Documentation
              </Link>
